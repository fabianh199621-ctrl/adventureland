...
var LP_ROLE = character.ctype == "merchant" || /merch/i.test(character.name) ? "merchant" : character.ctype == "priest" || /priest/i.test(character.name) ? "priest" : character.ctype == "ranger" || /ranger/i.test(character.name) ? "ranger" : "bot";
