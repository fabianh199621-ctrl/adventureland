...
function init_panel() {
    ...
    div.innerHTML = "<div id='lp_head'><b>LogicPlan " + BOT_VERSION + "</b><span class='lp_state' id='lp_state'>läuft</span><button data-act='chartoggle' title='Charakter & Inventar'>Char</button><button id='lp_toggle' title='Tabelle ein-/ausklappen'>▾</button></div><div id='lp_body'></div>";
    ...
    var inside = function (e) { var c = parent.document.getElementById("lp_char"); return e.target && (div.contains(e.target) || (c && c.contains(e.target))); };
...
// ---------- Wunschliste: fester Zielbuild für den Magier ----------
