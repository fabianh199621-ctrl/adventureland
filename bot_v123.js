...
function server_tip() { // bester Fund auf einem anderen Server (Zielbau-Rang, dann Preis)
    var list = server_targets.filter(function (f) { return Date.now() - f.t < 45 * 60000 && !f.same; });
