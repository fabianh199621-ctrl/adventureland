...
async function scan_all_merchants() {
    ...
    var res = null;
    try { res = await parent.api_call("pull_merchants", {}, { promise: true }); } catch (e) { game_log("Händler-Abfrage fehlgeschlagen: " + err_txt(e)); return; }
    var merchants = []; collect_merchants(res, merchants, 0);
