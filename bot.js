...
function heal_logic() {
    ...
    } else if (mp < 0.5 && mpot && missing_mp >= mpot.gives * 0.8) { // früher nachtrinken, damit MP nicht dauerhaft bei ~30 % hängt
