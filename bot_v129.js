...
function update_panel() {
    ...
    try { var wantW = panel.__wish ? 860 : 470; if (panel.__w != wantW) { panel.__w = wantW; panel.style.width = wantW + "px"; clamp_pos(panel, panel.offsetLeft, panel.offsetTop); } } catch (e) {}
...
function wish_ui_html() { // Zielbau-Tabelle
    var h = "<table class='lp_t' style='table-layout:fixed;width:100%'><tr><th style='text-align:left;width:60px'>Slot</th><th style='text-align:left;width:160px'>Zielitem (Tooltip = Werte)</th><th>Stufe</th><th style='text-align:left'>Stand</th><th style='text-align:left'>Bauen oder kaufen?</th><th style='text-align:left'>Angebote alle Server (★ = hier)</th><th style='text-align:left'>Zwischenlösung (nur auf Klick)</th><th></th></tr>";
    for (var slot in SLOT_TYPES) {
        ...
        h += "<tr><td style='text-align:left'>" + slot + "</td><td style='text-align:left'>" + sel + "</td><td>" + lv + "</td><td style='text-align:left'>" + stand + "</td><td style='text-align:left;white-space:normal;max-width:200px;font-size:11px'>" + (cur ? bvb_html(slot) + farm_html(slot) : "-") + "</td><td style='text-align:left;white-space:normal;max-width:190px'>" + offers_html(slot) + "</td><td style='text-align:left;white-space:normal;max-width:170px;font-size:11px'>" + alt_html(slot) + "</td><td><button data-act='focus' data-slot='" + slot + "' title='diesen Slot jetzt angehen'>Jetzt</button></td></tr>";
    }
    return h + "</table>";
}
